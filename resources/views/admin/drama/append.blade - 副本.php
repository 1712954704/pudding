    ...
    <div class="layui-fluid" style="margin-bottom: 70px;">
        <form  id="form" class="layui-form">
            ...
            <label class="layui-form-label"><span class="x-red">*</span>视频</label>
                ...
                <div class="layui-input-inline">
                    <input readonly="readonly" type="hidden" class="layui-input" name="address" id="address">
        ...
        layui.use(['form','upload','element'], function(){
            ...
            var uploadInst = upload.render({
                ...
                , done: function (res) {
                    ...
                    // var demo = $('#demo');
                    // // var img = $('#img');
                    $("#address").attr("value",res.file_path);
                    // demo.html('<span style="color: #8f8f8f;">上传成功!!!</span>');
                }
                , error: function () {
                    //演示失败状态，并实现重传
                    var demo = $('#demo');
